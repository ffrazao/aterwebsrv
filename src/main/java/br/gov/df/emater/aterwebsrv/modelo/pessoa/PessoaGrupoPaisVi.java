 ...
 */
@Entity
@Table(name = "pessoa_grupo_pais_vi", schema = EntidadeBase.PESSOA_SCHEMA)
public class PessoaGrupoPaisVi extends EntidadeBase implements _ChavePrimaria<Integer> {
	...
	public PessoaGrupoPaisVi() {
	}

	public PessoaGrupoPaisVi(Integer id) {
		setId(id);
	}

	public PessoaGrupoPaisVi(Integer id, String nome) {
		this(id);
		setNome(nome);
	}
