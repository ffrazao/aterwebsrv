 ...
 */
@Entity
@Table(name = "pessoa_grupo_bacia_hidrografica_vi", schema = EntidadeBase.PESSOA_SCHEMA)
public class PessoaGrupoBaciaHidrograficaVi extends EntidadeBase implements _ChavePrimaria<Integer> {
	...
	public PessoaGrupoBaciaHidrograficaVi() {
	}

	public PessoaGrupoBaciaHidrograficaVi(Integer id) {
		setId(id);
	}

	public PessoaGrupoBaciaHidrograficaVi(Integer id, String nome) {
		this(id);
		setNome(nome);
	}
