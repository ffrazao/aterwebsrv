...
/**
 * The persistent class for the pessoa_grupo_comunidade_vi database table.
 * 
 */
@Entity
@Table(name = "pessoa_grupo_comunidade_vi", schema = EntidadeBase.PESSOA_SCHEMA)
public class PessoaGrupoComunidadeVi extends EntidadeBase implements _ChavePrimaria<Integer> {
	...
	public PessoaGrupoComunidadeVi() {
	}

	public PessoaGrupoComunidadeVi(Integer id) {
		setId(id);
	}

	public PessoaGrupoComunidadeVi(Integer id, String nome) {
		this(id);
		setNome(nome);
	}
