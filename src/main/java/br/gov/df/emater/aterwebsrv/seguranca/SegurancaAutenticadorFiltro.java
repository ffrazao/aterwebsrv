 ...
 *      >Exemplo</a>
 */
public class SegurancaAutenticadorFiltro extends UsernamePasswordAuthenticationFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
		...
		authRequest.setDetails(new SegurancaAutenticadorDetalheWeb(request, Boolean.parseBoolean(administrador)));
